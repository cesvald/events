...
class SpacesControllerTest < ActionController::TestCase
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post :create, space: { amount: @space.amount, event_id: @space.event_id, place_id: @space.place_id }
    end
  ...
  test "should update space" do
    patch :update, id: @space, space: { amount: @space.amount, event_id: @space.event_id, place_id: @space.place_id }
    assert_redirected_to space_path(assigns(:space))
  end
