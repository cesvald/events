...
class ParticipationsControllerTest < ActionController::TestCase
  ...
  test "should create participation" do
    assert_difference('Participation.count') do
      post :create, participation: { amount: @participation.amount, modality_id: @participation.modality_id, space_id: @participation.space_id }
    end
  ...
  test "should update participation" do
    patch :update, id: @participation, participation: { amount: @participation.amount, modality_id: @participation.modality_id, space_id: @participation.space_id }
    assert_redirected_to participation_path(assigns(:participation))
  end
