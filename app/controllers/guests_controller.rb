class GuestsController < ApplicationController
	...
	def index
		@guests = (current_user.admin? || current_user.doctor? || current_user.viewer? || current_user.coord_eventer?) ? Guest.all : (current_user.coord_outside? ? Guest.by_outside(true) : Guest.by_country(current_user.country).by_outside(false))
